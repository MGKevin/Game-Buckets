...
#define button2 27  // Right button / #2
#define button3 23  // Middleiddle button / Gamemode / Reset
...
void blinkyellow()  // LED strip blinks Yellow. 0.5 second ON, 0.5 second OFF
{
...
void blinkred()  // LED strip blinks red. 1 second ON, 1 second OFF
{
  for (int led = 0; led < NUM_PIXELS; led++) {
...
void blinkblue()  // LED strip blinks blue. 0.5 second ON. 0.5 Second OFF
{
  for (int led = 0; led < NUM_PIXELS; led++) {
